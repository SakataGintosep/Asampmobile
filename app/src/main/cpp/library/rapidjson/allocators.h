...
public:
	...
	*/
	...
	MemoryPoolAllocator(size_t chunkSize = kDefaultChunkCapacity, BaseAllocator* baseAllocator = 0)
			...
			shared_(static_cast<SharedData*>(baseAllocator_ ? baseAllocator_->Malloc(
					SIZEOF_SHARED_DATA + SIZEOF_CHUNK_HEADER) : 0))
	{
...
private:
	...
	*/
	bool AddChunk(size_t capacity)
	{
		...
		if (ChunkHeader * chunk = static_cast<ChunkHeader*>(baseAllocator_->Malloc(
...
private:
	...
	friend
	class StdAllocator; // access to StdAllocator<!T>.*
