...
void TableSerializer::SerializeTable(DataStructures::Table* in, RakNet::BitStream* out)
{
	...
	DataStructures::Page<unsigned,
						 ...
						 _TABLE_BPLUS_TREE_ORDER>* cur = in->GetRows().GetListHead();
...
bool TableSerializer::DeserializeTable(unsigned char* serializedTable, unsigned int tableLength,
