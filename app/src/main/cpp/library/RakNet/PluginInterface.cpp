...
#pragma warning( disable : 4100 ) // warning C4100: <variable name> : unreferenced formal parameter
#endif
void PluginInterface::OnDirectSocketSend(const char* data, const unsigned bitsUsed,
...
#pragma warning( disable : 4100 ) // warning C4100: <variable name> : unreferenced formal parameter
#endif
void PluginInterface::OnDirectSocketReceive(const char* data, const unsigned bitsUsed,
		PlayerID remoteSystemID)
{
}
#ifdef _MSC_VER
#pragma warning( disable : 4100 ) // warning C4100: <variable name> : unreferenced formal parameter
#endif
void PluginInterface::OnInternalPacket(InternalPacket* internalPacket, unsigned frameNumber,
