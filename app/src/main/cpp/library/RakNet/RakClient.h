...
public:
	...
	bool Connect(const char* host, unsigned short serverPort, unsigned short clientPort,
	...
	void PingServer(const char* host, unsigned short serverPort, unsigned short clientPort,
